---
title: "Migration: cw6 — CLAUDE.md section ownership"
description: What changed in the cw6 feature (section ownership in project-root CLAUDE.md) and how to opt in.
---
